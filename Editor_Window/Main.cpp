	...
	_In_ int       nCmdShow)
{
	...
	// 메시지 큐에 아무것도 없는 경우 아무 메시지도 가져오지 않게됨

	// PeekMessage : 메시지 큐에 메시지 유무에 상관 없이 함수가 리턴된다.
	//				 리턴 값이 true인 경우 메시지가 있고 false인 경우는 메시지가 없다라고 가르켜준다.
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_PAINT:
	{
		...
		// GDI 모듈에 의해서 관리된다.
		// 어떤 폰트를 사용할지, 어떤 선의 굵기를 정해줄건지, 어떤 색상으로 그려줄지
